...
client.login("MTIyNDExMTcxMTUxOTUxMDU4MA.GOxlZJ.a7VRjZI6y8xL1q8Vp0ISHl14O79-J5prrwUmVw");

require('./slash.js')
app.get('/', function (req, res) {
  res.send('code by F i')
})
...
var listeners = app.listen(3004, function () {
  console.log("Your app is listening on port by F i" + `3004`)
});

client.on('ready', () => {
  console.log(`Bot is On! ${client.user.tag} by F i`);
});
